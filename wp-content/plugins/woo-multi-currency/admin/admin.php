...
class WOOMULTI_CURRENCY_F_Admin_Admin {
		...
		if ( is_plugin_active( 'wp-super-cache/wp-cache.php' ) && ! is_plugin_active( 'country-caching-extension-for-wp-super-cache/cc_wpsc_init.php' ) ) { ?>
			<div class="notice notice-warning">
				...
				<div class="villatheme-content">
					<p>
						<?php echo __( 'You are using <strong>WP Super Cache</strong>. Please install and active <strong>Country Caching For WP Super Cache</strong> that helps <strong>WooCommerce Multi Currency</strong> is working fine with WP Super Cache.', 'woo-multi-currency' ) ?>
					</p>
				</div>
	...
	public function menu_page() {
		add_menu_page(
			esc_html__( 'WooCommerce Multi Currency', 'woo-multi-currency' ), esc_html__( 'Multi Currency', 'woo-multi-currency' ), 'manage_options', 'woo-multi-currency', array(

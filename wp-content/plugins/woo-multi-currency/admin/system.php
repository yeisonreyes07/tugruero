...
class WOOMULTI_CURRENCY_F_Admin_System {
	...
	public function menu_page() {
		add_submenu_page(
			'woo-multi-currency', esc_html__( 'System Status', 'woo-multi-currency' ), esc_html__( 'System Status', 'woo-multi-currency' ), 'manage_options', 'woo-multi-currency-system-status', array(
				$this,
				'page_callback'
			)
		);

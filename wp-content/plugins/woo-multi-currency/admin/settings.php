					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								<a class="vi-ui button yellow"
								   href="https://goo.gl/2hWzFT"><?php echo esc_html__( 'Unlock This Feature', 'woo-multi-currency' ) ?></a>
						...
						<tr valign="top">
							...
							<td>
								<a class="vi-ui button yellow"
								   href="https://goo.gl/2hWzFT"><?php echo esc_html__( 'Unlock This Feature', 'woo-multi-currency' ) ?></a>
								<p class="description"><?php esc_html_e( 'Currency will be changed but It does not use URL. It will good for SEO. Now It is not compatible with Cache plugins.', 'woo-multi-currency' ) ?></p>
							</td>
						</tr>
						<tr valign="top">
						...
						<table class="optiontable form-table">
							<tr>
								...
								<td>
									...
									<p class="description"><?php esc_html_e( 'All product fields of WooCommerce Multi Currency will be copied. When you switch language, Currency will change. ', 'woo-multi-currency' ) ?></p>
								</td>
							</tr>
							<tr>
								<th scope="row">

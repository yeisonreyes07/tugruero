        ...
        public function register_pointer () {
            ...
            $args[] = array (
                ...
                'content'    => sprintf ( '<h3>YITH WooCommerce Uploads</h3> <p> %s </p>',
                    __ ( 'In YIT Plugins tab, you can find the YITH WooCommerce Uploads options.<br> From this menu, you can access all settings of the activated YITH plugins.', 'yith-woocommerce-additional-uploads' ) . '<br>' . $premium_message
                ),

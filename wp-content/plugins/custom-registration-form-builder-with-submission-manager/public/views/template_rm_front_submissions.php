    ...
    <div class="operationsbar">
        ...
        <div class="nav">
                ...
                if (!is_user_logged_in())
                {
                    ...
                    <div class="rmtabs_head" title="Logout"><i class="material-icons">exit_to_app</i><a href="<?php echo wp_logout_url( get_permalink() );?>"><?php _e('Logout','custom-registration-form-builder-with-submission-manager'); ?></a></div>
                    <?php
                    }
                ?>

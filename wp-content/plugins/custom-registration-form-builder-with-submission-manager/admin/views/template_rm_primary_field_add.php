...
if(strtolower($data->model->field_type)=="userpassword" || strtolower($data->selected_field)=='userpassword'){
    ...
    $form->addElement(new Element_HTML("<div class='childfieldsrow' id='pwd_strength_options'>"));
        ...
        $form->addElement(new Element_Textbox("<b>".__('Short','custom-registration-form-builder-with-submission-manager')."</b>", "pwd_medium_msg", array("class" => "rm_static_field", "value" => $data->model->field_options->pwd_medium_msg, "longDesc"=>'')));
        $form->addElement(new Element_Textbox("<b>".__('Short','custom-registration-form-builder-with-submission-manager')."</b>", "pwd_strong_msg", array("class" => "rm_static_field", "value" => $data->model->field_options->pwd_strong_msg, "longDesc"=>'')));
    $form->addElement(new Element_HTML('</div>')); 

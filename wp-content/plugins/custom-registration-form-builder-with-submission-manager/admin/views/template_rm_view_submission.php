                ...
                <div class="rm-submission-label rm-custom_status-wrap">
                    ...
                    <div class="rm-submission-value rm-custom-status-lr">
                        ...
                        <div class="rm-submission-value rm-add-custom-status-value" style="display:none">
                           ...
                           <span class="rm_buy_pro_inline"><?php printf(__('To unlock Custom Statuses (and many more), please upgrade <a href="%s" target="blank">Click here</a>','custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/comparison/'); ?> </span>

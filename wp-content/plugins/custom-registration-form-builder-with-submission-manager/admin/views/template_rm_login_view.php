...
<div class="rmagic">
    <div class="operationsbar">
        <div class="rmtitle"><?php echo _e('Logged In View', 'custom-registration-form-builder-with-submission-manager'); ?></div>
    </div>
    ...
    <div class="rmcontent " ng-controller="loggedInViewCtrl"  ng-app="loggedInViewApp">
        ...
        <div class="rm-logged-in-view rm-dbfl">
                ...
                <div class="rm-logged-in-view-wrap">
                    ...
                    <div class="rm-logged-in-rf rm-difl">
                        ...
                        <div class="rm-logged-welcome">
                            ...
                            <!-- Show user name -->
                            <span class="rm-user-display-name rm-dbfl" ng-if="displayUsername"><?php _e('Full Name','custom-registration-form-builder-with-submission-manager'); ?></span>
            ...
            <div class="rmrow"> <div class="rmnotice"><?php _e('The color of hyperlink anchor text for My Account and Logout will appear based on your theme on the front end. Colors displayed here are only for representation.','custom-registration-form-builder-with-submission-manager') ?></div></div>

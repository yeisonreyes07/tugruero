                        ...
                        <div class="rm-address-field-state">
                            <ul>
                                ...
                                <li>
                                          ...
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'limited\')">'.__('Limited Countries', 'custom-registration-form-builder-with-submission-manager').'s</label>    
                                </li>

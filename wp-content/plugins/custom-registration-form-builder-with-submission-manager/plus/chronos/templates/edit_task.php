            ...
            <div class="rm-task-slide rm-task-slide1">     
                ...
                <div class="rmrow">
                    <div class="rmfield" for="rmc_task_name">
                        <label><sup class="required">* </sup><b><?php _e('Task Name','custom-registration-form-builder-with-submission-manager'); ?></b></label>
                    </div>
                    <div class="rminput">
                ...
                <div class="childfieldsrow" id="rmc_enable_send_mail_action_ctrl_subpanel">                
                    <div class="rmrow">
                        <div class="rmfield" for="rmc_action_send_mail_sub">
                            <label><sup class="required">*</sup><?php _e('Subject','custom-registration-form-builder-with-submission-manager'); ?></label>
                        </div>
                        <div class="rminput">

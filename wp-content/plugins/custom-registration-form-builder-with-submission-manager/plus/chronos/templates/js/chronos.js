...
function rmc_run_task_now(task_id) {
    if(typeof task_id != 'undefined') {
        ...
        jQuery("#id_rmc_run_task_now_"+task_id).text(chronos_js_vars.running).addClass('rm_deactivated');            
        jQuery.post(ajaxurl, data,function(resp){
            ...
            if(resp['result'] == 'error') {
                ...
                jQuery("#id_rmc_run_task_now_"+task_id).text(chronos_js_vars.task_finished);
        });
    }
}

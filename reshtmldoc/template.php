...
<page backtop="28mm" backbottom="18mm" backleft="10mm" backright="10mm" style="font-size: 9pt">
    ...
    <table style="width: 100%; border:1px solid #000;">
        ...
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">2- SEGUNDA: Ud., podrá solicitar nuestros servicios mediante nuestro Call-Center por los números telefónicos 0500 GRUERO - 0 (0500 478376 - 0), (0212)-237-9227, (0212)-419-0105, (0212)-227-5273, Número de contingencia: (0424)-135-7579.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">3- TERCERA: Los servicios adquiridos mediante los planes sólo se prestaran si el vehículo sufrió una avería que le imposibilite andar y será auxiliado hacia el lugar requerido por la persona, siempre y cuando el tramo a recorrer no exceda el kilometraje cubierto por el plan contratado. </td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">4- CUARTA: Cuando el recorrido que realiza la grúa desde el lugar de origen del vehículo accidentado hasta el lugar de destino indicado por el cliente, excede el kilometraje establecido en el plan de grúas, el cliente deberá pagar, previo a la prestación del servicio, lo correspondiente al kilometraje adicional. El monto a cancelar será indicado por el operador del Call Center.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">5- QUINTA El presente plan de auxilio vial posee validez de un (1) año. Las fechas de vigencia del plan están descritas arriba.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">6- SEXTA: Vencido como fuera el lapso de tiempo por el cual fue contratado el servicio, Ud. entiende que no posee “mes de gracia”, y en caso de necesitar utilizar los servicios de la empresa, deberá adquirir nuevo plan o renovar el mismo plan que ya tenía. </td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">7- SEPTIMA: “Soluciones Tu Gruero C.A.” no trabaja con reembolsos de facturas por servicios tomados de forma particular, en tal sentido, no se reconocerá ningún servicio de auxilio vial (grúa) tomado de forma particular. Por tanto, no se realizará el reembolso de cantidades pagadas a proveedores externos a la compañía, cuando no sean autorizados previamente por el respectivo personal de la empresa.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">8- OCTAVA: Los servicios desde el estado Nueva Esparta hacia cualquier estado o puerto perteneciente al territorio continental de la República Bolivariana de Venezuela, o viceversa, no están cubiertos por el plan adquirido por su persona. Así como no están cubiertos los estados Amazonas y Delta Amacuro.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">9- NOVENA: El servicio de grúas contratado estará activo, y el cliente lo podrá disfrutar luego de veinte (20) días hábiles del pago del mismo.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">10- DECIMA: El servicio de grúas contratado por el cliente será responsabilidad plena y absoluta de Soluciones Tu Gruero, C.A. entendiéndose así que cualquier reclamo, crítica y/o sugerencia del servicio debe ser comunicado a esta compañía.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">11- DECIMA PRIMERA: En caso de adquirir el producto financiado, Ud., faculta a “Soluciones Tu Gruero C.A.” para realizar el proceso de cobranza de las cuotas restantes mediante la herramienta de domiciliación de tarjeta de crédito en su página web www.tugruero.io</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">12- DECIMA SEGUNDA: Si adquirió el producto financiado, en caso de retrasos en el pago de las siguientes cuotas en la fecha, lugar, monto y forma convenida, se suspenderá inmediatamente el derecho a utilizar los servicios ofrecidos por “Soluciones Tu Gruero C.A.”</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">13- DECIMA TERCERA: En caso de adquirir el producto financiado, el incumplimiento en el pago por parte del cliente., automáticamente acarrea un incremento de la cuota, en tal sentido, se le realizará recargo de un por ciento (1%) por cada día continuo de atraso sobre el monto de la cuota vencida. Además, no podrá disfrutar el servicio por una cantidad de un (1) día hábil acumulativo por cada día de retraso en pago correspondiente, contados a partir de la fecha de pago de la(s) cuotas(s) pendientes(s). Pasados 60 días de mora, se procederá a cancelar el plan (suscripción) del cliente, y este deberá adquirir un nuevo plan si desea afiliarse nuevamente.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">14- DECIMA CUARTA: “Soluciones Tu Gruero C.A.” no realiza reintegro o devolución de dinero en caso de que el cliente no pueda o no quiera pagar el resto de las cuotas pendientes, habiendo o no utilizado alguno de nuestros servicios.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">15- DECIMA QUINTA: En el caso de que el vehículo afiliado cuente con servicios ilimitados de 50 Km (TUGRUERO PLUS o TUGRUERO GOLD), a pesar que las averías/fallas que puede sufrir un vehículo son ilimitadas, el cliente cuenta con 3 servicios de grúa por avería/falla reportada durante la vigencia de su plan.</td>
        </tr>
        <tr style="vertical-align: top">
            <td style="width: 100%; padding-bottom:10px; font-size:9px">16- DECIMA SEXTA: El plan de grúas TUGRUERO GOLD cuenta con un (01) servicio de máximo 100 Km y podrá ser utilizado sólo si el vehículo accidentado se encuentra en plena vía o en un lugar de resguardo y el lugar de destino es el domicilio establecido en el plan adquirido.</td>
        </tr>
    </table>
